      ...
      <div className="flex min-h-screen flex-1">
        ...
        <div className="relative hidden w-0 flex-1 lg:block">
          <img
            ...
            src="https://media.dev.to/cdn-cgi/image/width=1080,height=1080,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fpbais26m76w2auxypa16.png"
            alt=""
          />
        </div>
      </div>
